...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumpnails that get clicks ,without hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                   Our AI understands what makes a video go viral and designs thumpnails accordingly.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your view with AI optimizedd designs </h3>
