        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Generate Your First Thumpnail For Free</span>
            ...
            >
                AI Thumpnail Generator To Your <span className="move-gradient px-3 rounded-xl text-nowrap">Videos.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
               Stop wasting hours on design.Get high-converting thumpnails in seconds with our advanced AI</motion.p>
